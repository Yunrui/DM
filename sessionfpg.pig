...
Path = filter Path0 by (userLogin matches '.*@.*') AND (NOT documentPath matches '.*getsitecollectionservice.asmx.*') AND (NOT documentPath matches '.*default.*') AND (NOT documentPath matches '/') AND (NOT documentPath matches '.*authenticate.*') AND (NOT documentPath matches '.*PII.*') AND (NOT documentPath matches '.*redirect.*') AND (NOT documentPath matches '.*blank.*') AND (NOT documentPath matches '.*sitecollections.*') AND (NOT documentPath matches '.*picker.*') AND (NOT documentPath matches '.*viewproperties.*') AND (NOT documentPath matches '.*picker.*') AND (NOT documentPath matches '.*accessdenied.*')AND (NOT documentPath matches '.*manageuserprofileserviceapplication.*') AND (NOT documentPath matches '.*ta_searchadministration.*') AND (NOT documentPath matches '.*ta_bcshome.*') AND (NOT documentPath matches '.*ta_managesssvcapplication.*') AND (NOT documentPath matches '.*tenantadminapps.*')AND(NOT documentPath matches '.*manageuserprofileserviceapplication.*')AND (NOT documentPath matches '.*profmngr.*')AND (NOT documentPath matches '.*audience_list.*')AND (NOT documentPath matches '.*ta_bshome.*')AND (NOT documentPath matches '.*ta_viewbdcapplication.*')AND (NOT documentPath matches '.*ta_viewappconnections.*')AND (NOT documentPath matches '.*ta_searchadministration.*')AND (NOT documentPath matches '.*ta_managesssvcapplication.*');
